...
| Item      | Value                                                                            |
|-----------|----------------------------------------------------------------------------------|
| Location  | `<baseDir>/messages`, where `baseDir` is set by `Web.baseDir(Path)`              |
