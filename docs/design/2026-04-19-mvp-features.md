...
| Static file serving         | `web.files("/assets", Path.of("static"))` with Content-Type inference, ETag/Last-Modified, path traversal protection. Needed to serve the SPA's CSS/JS/images.                                                                                             |
