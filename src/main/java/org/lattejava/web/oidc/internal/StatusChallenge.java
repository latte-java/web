...
/**
 * Status-code challenge for SPA and API profiles. Clears credentials and returns 401 on an authentication failure (the
 * {@code retryable} flag is ignored — a fetch client cannot follow a meta-refresh); 403 on authorization failure; 503
